    ...
    <header className="flex items-center justify-between px-4 md:px-8 py-4 md:py-5 bg-[#fafafa] border-b border-gray-100">
      ...
      <div className="flex items-center space-x-2 md:space-x-6 ml-4">
        ...
        <button 
          ...
          className={`flex items-center px-2 md:px-4 py-1.5 text-[10px] md:text-xs font-bold uppercase tracking-wider transition-colors rounded-full ${
            role === 'ADMIN' 
        ...
        >
          ...
          <span className="hidden md:inline">{role === 'ADMIN' ? 'Admin Role / Viewer' : 'Viewer Role (Read-only)'}</span>
